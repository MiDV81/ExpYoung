...
a = 200 #distancia entre rendijas (en nº de veces dy)
L = 2  # anchura de las rendijas (en nº de veces dy)
d = 50 # distancia a la pantalla de las rendijas (en nº de veces dx)

namejpg = f'{numrendijas}rend_a{a}_d{d}.jpg'
...
fig2.suptitle(f'{numrendijas} rendija(s),d={d},a={a}')
